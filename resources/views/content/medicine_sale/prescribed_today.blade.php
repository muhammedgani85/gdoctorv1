...
<div class="row">
 ...
 <div class="card-header d-flex justify-content-between align-items-center" style="padding-bottom: 20px;">
    <h5 style="color:red;">Medicine</h5>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-primary" id="prescSaveBtn">Ok</button>
    ...
    <form id="notesForm">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body row g-3">
          <div class="col-md-6"><input type="text" class="form-control" name="weight" placeholder="Weight" disabled></div>
          <div class="col-md-6"><input type="text" class="form-control" name="height" placeholder="Height" disabled></div>
          <div class="col-md-6"><input type="text" class="form-control" name="bp" placeholder="BP" disabled></div>
          <div class="col-md-6"><input type="text" class="form-control" name="o2" placeholder="O2 Level" disabled></div>
          <div class="col-md-6"><input type="text" class="form-control" name="sugar_pp" placeholder="Sugar PP" disabled></div>
          <div class="col-md-6"><input type="text" class="form-control" name="sugar_af" placeholder="Sugar AF" disabled></div>
          <div class="col-md-6"><input type="text" class="form-control" name="consulting_fees" placeholder="Consulting Fees" disabled></div>
          <div class="col-md-6"><input type="text" class="form-control" name="medicine" placeholder="Medicine"></div>
          <div class="col-md-6">
            <select name="scan_required" class="form-select" disabled>
              <option value="">Scan Required?</option>
              <option value="Yes">Yes</option>
              <option value="No">No</option>
            </select>
          </div>
          <div class="col-md-6"><input type="text" class="form-control" name="scan_centre" placeholder="Scan Centre Name" disabled></div>
          <div class="col-12"><textarea class="form-control" name="notes" placeholder="Notes" rows="3" disabled></textarea></div>
        </div>
        <div class="modal-footer">
      ...
      $.get('/prescriptions/' + appointmentId, function(res) {
        ...
        if (res.status === 'success' && res.items && res.items.length > 0) {
          res.items.forEach(function(item) {
            let row = `<tr>
              <td><select class="form-control presc-medicine-select" disabled><option value="">Select Medicine</option></select></td>
              <td><input type="number" class="form-control presc-morning" min="0" value="${item.morning || 0}" disabled></td>
              <td><input type="number" class="form-control presc-afternoon" min="0" value="${item.afternoon || 0}" disabled></td>
              <td><input type="number" class="form-control presc-evening" min="0" value="${item.evening || 0}" disabled></td>
              <td><input type="number" class="form-control presc-days" min="1" value="${item.days || 1}" disabled></td>
         ...
         let row = `<tr>
  <td>
    <select class="form-control presc-medicine-select" disabled>
      <option value="">Select Medicine</option>
    </select>
  </td>
  <td><input type="number" class="form-control presc-morning" min="0" value="0" disabled></td>
  <td><input type="number" class="form-control presc-afternoon" min="0" value="0" disabled></td>
  <td><input type="number" class="form-control presc-evening" min="0" value="0" disabled></td>
  <td><input type="number" class="form-control presc-days" min="1" value="1" disabled></td>
    ...
    $('#prescSaveBtn').on('click', function() {
      ...
      swal({
        title: "Do you want Prescription?",
          ...
          $.ajax({
            ...
            success: function(res) {
              ...
              if (value === "print") {
                ...
                swal("Print Prescription cancelled!", {icon: "success"});
              }
            },
            error: function(xhr) {
